...
// Source: github.com/trancongthanh1992/samplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetAccountForNoKeyUpdate(arg0 context.Context, arg1 int64) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountForNoKeyUpdate", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetAccountForNoKeyUpdate(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountForNoKeyUpdate", reflect.TypeOf((*MockStore)(nil).GetAccountForNoKeyUpdate), arg0, arg1)
}
