...
func (e eqCreateUserParamsMatcher) Matches(x interface{}) bool {
	...
	// Save `HashedPassword` into struct eqCreateUserParamsMatcher.
...
func TestCreateUserAPI(t *testing.T) {
	...
	// hashedPaswword, err := util.HashedPassword(password)
...
func requireBodyMatchUser(t *testing.T, body *bytes.Buffer, user db.User) {
	...
	var gotUser db.User
	// map byte into struct
	// serialization or decode
